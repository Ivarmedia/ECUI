...
export class Loader {
    ...
    setLoaderImg(url) {
        ...
        if(!Utils.isNullOrEmpty(url)) {
            ...
            this.logo.innerHTML = `<svg class="ECUI-General-Loader-Logo-Lines" x="0px" y="0px" viewBox="0 0 400 400" xml:space="preserve"> <line class="${this.classes.secondaryLogoLines} ECUI-General-Loader-Logo-Line-First" x1="156.9" y1="84.6" x2="390" y2="84.6"/> <polyline class="${this.classes.secondaryLogoLines} ECUI-General-Loader-Logo-Line-Second" points="345.3,212.2 92.7,212.2 92.7,343.2 390,343.2 "/> </svg> <div class="ECUI-General-Loader-Logo-Squares-Container"> <svg class="${this.classes.primaryLogo} ECUI-General-Loader-Logo-Square"  viewBox="0 0 400 400"><rect width="400" height="400"/></svg> <svg class="${this.classes.primaryLogo} ECUI-General-Loader-Logo-Square"  viewBox="0 0 400 400"><rect width="400" height="400"/></svg> </div> `;
        }
    ...
    buildCss() {
        ...
        loaderCss.setAttribute('type', 'text/css');
        loaderCss.id = "ECUI-Loader-Style";
        ...
        var cssRules = `
            ...
            .ECUI-General-Loader-spinner:nth-child(2) { filter: blur(3px); opacity: 0.6 }
            .ECUI-General-Loader-spinner-ring { position: absolute; margin: 3px; width: 134px; height: 134px; border-radius: 50%; border-style: solid; border-width: 5px; border-bottom-color: transparent; border-left-color: transparent; border-right-color: transparent; animation: generalSpinnerRing 1.2s linear infinite; }
            ...
            .ECUI-General-Loader-Logo-Squares-Container { width: 16.4px; height: 16.4px; position: absolute; top: 0px; left: 0px; filter: blur(0.5px); }
        ...
        if (loaderCss.styleSheet) {
            loaderCss.styleSheet.cssText = cssRules;
        } else {
            loaderCss.appendChild(document.createTextNode(cssRules));
        }
